...
<template>
  <div class="w-full flex flex-col items-center gap-10 justify-center p-10">
    <svg xmlns="http://www.w3.org/2000/svg"
      ...
      <defs>
        ...
        <linearGradient id="linear-gradient-12" x1="-597.66" y1="226.59" x2="-578.4" y2="226.59"
                        gradientTransform="matrix(-1, 0, 0, 1, -157.58, 0)"
      ...
      <path
        ...
        transform="translate(-1.64 -46.71)" fill="#01a6c7" opacity="0.24"
        style="isolation:isolate"></path>
      <ellipse cx="291.51" cy="335.87" rx="156.49" ry="13.56" fill="#01a6c7" opacity="0.24"
               style="isolation:isolate"></ellipse>
      <polygon points="81.24 65.4 101.41 57.07 212.32 67.47 212.32 78.02 81.24 78.41 81.24 65.4"
               fill="#01a6c7"></polygon>
      <rect x="98.05" y="53.8" width="19.85" height="275.75" fill="#01a6c7"></rect>
      <path
        ...
        transform="translate(-1.64 -46.71)" fill="#01a6c7"></path>
      <polygon
        ...
        opacity="0.5" fill="url(#linear-gradient)"></polygon>
      <path
      ...
      <polygon points="172.66 323.73 182.62 323.73 182.62 289.62 172.45 289.62 172.66 323.73"
               opacity="0.5" fill="url(#linear-gradient-3)"></polygon>
      <polygon points="243.42 323.73 253.38 323.73 253.38 289.62 243.21 289.62 243.42 323.73"
               opacity="0.5" fill="url(#linear-gradient-4)"></polygon>
      ...
      <polygon
        ...
        opacity="0.5" fill="url(#linear-gradient-6)"></polygon>
      ...
      <path
        ...
        transform="translate(-1.64 -46.71)" fill="url(#linear-gradient-9)"></path>
      <path
        ...
        transform="translate(-1.64 -46.71)" fill="url(#linear-gradient-10)"></path>
      <path
        d="M403,158.39v4.24H155.37v-4.24a8.59,8.59,0,0,1,8.61-8.6H394.37A8.59,8.59,0,0,1,403,158.39Z"
        transform="translate(-1.64 -46.71)" fill="url(#linear-gradient-11)"></path>
      <path
        ...
        transform="translate(-1.64 -46.71)" fill="url(#linear-gradient-12)"></path>
      <path
        ...
        transform="translate(-1.64 -46.71)" fill="#606161"></path>
      <path
        d="M421.57,211.68a9.53,9.53,0,0,0,.31,1.47c.12.2,23.1,8.43,23.1,8.43s1,.27,1.08-.28.35-1.43.35-1.43Z"
        transform="translate(-1.64 -46.71)" fill="url(#linear-gradient-13)"></path>
      <path
      ...
      <path
        ...
        transform="translate(-1.64 -46.71)" opacity="0.5" fill="url(#linear-gradient-14)"></path>
      <path
        ...
        transform="translate(-1.64 -46.71)" opacity="0.5" fill="url(#linear-gradient-15)"></path>
      ...
      <polygon points="420.6 206.68 402.38 207.51 413.95 231.58 432.19 231.01 420.6 206.68"
               opacity="0.5" fill="url(#linear-gradient-16)"></polygon>
      <path
        ...
        transform="translate(-1.64 -46.71)" fill="url(#linear-gradient-17)"></path>
      <polygon
      ...
      <path d="M391.75,229.53l38.2,5.59L416.44,251h0a13.4,13.4,0,0,0-8.31-6.74L367.79,233l.31-7.45Z"
            transform="translate(-1.64 -46.71)" fill="#01a6c7"></path>
      <path d="M132,78.14" transform="translate(-1.64 -46.71)"
      ...
      <polygon points="98.05 58.6 98.05 78.41 81.24 78.41 81.24 65.4 98.05 58.6"
               fill="url(#linear-gradient-24)"></polygon>
      <polygon points="98.05 62.02 98.05 78.41 81.24 78.41 81.24 68.81 98.05 62.02"
               fill="url(#linear-gradient-25)"></polygon>
      <rect x="175.26" y="128.94" width="55.49" height="4.35" rx="2.17" fill="#01a6c7"></rect>
      <rect x="175.26" y="136.77" width="30.82" height="2.42" rx="1.21" fill="#01a6c7"></rect>
      <rect x="188.1" y="142.78" width="30.82" height="2.42" rx="1.21" fill="#01a6c7"></rect>
      <rect x="209.01" y="136.77" width="4.52" height="2.39" rx="1.19" fill="#01a6c7"></rect>
      <rect x="215.53" y="136.77" width="4.52" height="2.39" rx="1.19" fill="#01a6c7"></rect>
      <rect x="178.57" y="142.78" width="4.52" height="2.39" rx="1.19" fill="#01a6c7"></rect>
      <rect x="222.05" y="136.77" width="4.52" height="2.39" rx="1.19" fill="#01a6c7"></rect>
      <rect x="164.4" y="262.52" width="82.2" height="12.48" fill="#01a6c7"></rect>
      <rect x="162.28" y="293.01" width="100.42" height="26.27" fill="#01a6c7"></rect>
      <path
        ...
        transform="translate(-1.64 -46.71)" fill="#fff"></path>
      <path
      ...
      <path
        d="M119.49,348.88c-1.53,3.13-2.62,7-.78,10a40.86,40.86,0,0,0,3,3.34c4,4.88,1.89,12.22-1.24,17.67a10.73,10.73,0,0,0-1.83,4.61c-.12,2.61,1.77,4.78,3.34,6.86s2.71,4.69,1.65,6.86a159.88,159.88,0,0,1-35.09-8.31c-1.63-.6-3.22-1.23-4.82-1.92-.33-3.64.82-7.44,2.29-10.87,1.63-3.76,4.13-7.67,4.76-11.8.57-3.76-.09-7.28,1.08-11.07A25.06,25.06,0,0,1,107,338c2.11-.73,4.42-1.24,6-2.77a12,12,0,0,0,2.47-4q4.24-9.21,8.42-18.48c1.3-2.83,3-6,6.11-6.5,2.38-.39,4.76,1.18,5.93,3.28a11.74,11.74,0,0,1,1.06,7.05C135.65,328.9,125,337.8,119.49,348.88Z"
        transform="translate(-1.64 -46.71)" opacity="0.5" fill="url(#linear-gradient-26)"></path>
      <path
